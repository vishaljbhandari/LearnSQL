/*
	Anti Join
	-> used to make the queries run faster
	-> very powerful SQL construct for faster queries
	-> returns rows from the first table where no matches are found in the second table
	-> It is opposite of a semi-join
